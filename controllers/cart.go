...
func (app *Aplication) AddToCart() gin.HandlerFunc {
...
func (app *Aplication) RemoveItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		productQueryID := c.Query("id")
		if productQueryID == "" {
			log.Println("product is empty")
...
func (app *Aplication) BuyFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
...
func (app *Aplication) InstantBuy() gin.HandlerFunc {
	return func(c *gin.Context) {
		productQueryID := c.Query("id")
		if productQueryID == "" {
			log.Println("product is empty")
